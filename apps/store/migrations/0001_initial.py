    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tax_fee', models.DecimalField(decimal_places=2, default=0.0, max_digits=12)),
                ('total', models.DecimalField(decimal_places=2, default=0.0, max_digits=12)),
                ('payment_status', models.CharField(choices=[('PAGO', 'PAGO'), ('PENDENTE', 'PENDENTE'), ('PROCESSANDO', 'PROCESSANDO'), ('CANCELADO', 'CANCELADO'), ('ENVIADO', 'ENVIADO'), ('ENTREGUE', 'ENTREGUE')], default='PENDENTE', max_length=30)),
                ('order_status', models.CharField(choices=[('PENDENTE', 'PENDENTE'), ('REALIZADA', 'REALIZADA'), ('CANCELADA', 'CANCELADA')], default='PENDENTE', max_length=20)),
